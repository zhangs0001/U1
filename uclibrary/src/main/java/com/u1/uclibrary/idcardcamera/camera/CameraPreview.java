...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private PhAutoFocusManager mPhAutoFocusManager;
    private SensorControler mSensorControler;
    private int iFontCameraIndex, iBackCameraIndex;
    private boolean iBack = true;
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        getCameraInfo();
        camera = PhCameraUtils.openCamera(iBack ? iBackCameraIndex : iFontCameraIndex);
        if (camera != null) {
            try {
                ...
                Camera.Size bestSize2 = getBestSize(parameters.getSupportedPreviewSizes());
                if (bestSize != null) {
                ...
                focus();//首次对焦
                //定时对焦
                //mPhAutoFocusManager = new PhAutoFocusManager(camera);
            } catch (Exception e) {
     ...
     * @return 最佳尺寸
     */
    private Camera.Size getBestSize2(List<Camera.Size> sizes) {
    ...
    private void release() {
        if (camera != null) {
            ...
            if (mPhAutoFocusManager != null) {
                mPhAutoFocusManager.stop();
                mPhAutoFocusManager = null;
            }
        }
    }
