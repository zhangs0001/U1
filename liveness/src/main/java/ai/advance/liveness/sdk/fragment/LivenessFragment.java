...
public class LivenessFragment extends Fragment implements Detector.DetectorInitCallback, LivenessCallback {
    ...
    private void initData() {
        ...
        switch (value) {
            case 0:
                mLivenessView.startDetection(this, true, Detector.DetectionType.BLINK, Detector.DetectionType.MOUTH);
                break;
            case 1:
                mLivenessView.startDetection(this, true, Detector.DetectionType.MOUTH, Detector.DetectionType.POS_YAW);
                break;
        }
    }
